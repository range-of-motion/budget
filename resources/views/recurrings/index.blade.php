            ...
            @if (count($recurrings))
                @foreach ($recurrings as $recurring)
                    <div class="box__section row">
                        ...
                        <div class="row__column row__column--middle">
                            @if ($recurring->status)
                                <span style="border-radius: 5px; background: #D8F9E8; color: #51B07F; padding: 5px 10px; font-size: 14px; font-weight: 600;"><i class="fas fa-check fa-xs"></i> {{ __('fields.active') }}</span>
                            @else
                                <span style="border-radius: 5px; background: #FFE7EC; color: #F25C68; padding: 5px 10px; font-size: 14px; font-weight: 600;"><i class="fas fa-times fa-xs"></i> {{ __('fields.inactive') }}</span>
                            @endif
                        </div>
                        <div class="row__column row__column--middle">
                            @if ($recurring->tag)
